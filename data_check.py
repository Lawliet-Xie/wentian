...
if __name__ == "__main__":
    args = parse_args()
    os.chdir('/public/home/yuqi/lawliet/nlp/wentian/')
    print("*"*10, "Checking query_embedding ...")
    data_check(f"./logs/{args.path}/output/query_embedding", file_type="query")
    print("*"*10, "Checking doc_embedding ...")
    data_check(f"./logs/{args.path}/output/doc_embedding", file_type="doc")
